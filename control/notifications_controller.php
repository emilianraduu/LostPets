<?php
     ...
     if (strcmp($user_id,"") == 0) 
        { echo "Error: user_id must be specified as GET parameter."; exit; }
     
     if (strcmp($command,"") == 0) 
       {
        echo "Sorry, no command specified. Exiting...";
        exit;
       }
     
  
     $servername = "localhost";
     $username = "lostpets_account";
     $password = "pass";
     $dbname = "lost_pets";
    ...
    if (strcmp($command,"INSERT_NOTIFICATION") == 0) 
    {
        ...
        if (strcmp($notification_text,"") == 0) 
          {
            echo "Error: notification_text must be specified as GET parameter.";
            exit;
         }
        if (strcmp($is_viewed,"") == 0) 
         {
           echo "Error: is_viewed must be specified as GET parameter.";
           exit;
         }
